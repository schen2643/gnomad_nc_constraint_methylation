...
# awk 'BEGIN {FS= "\t"; OFS= "\t"}; {print $3,$4,$5,$6}' context_prepared_methyl14_weighted_logit_x.txt > context_prepared_methyl14_weighted_logit_x.bed &

df_met = pd.read_csv("context_prepared_methyl14_weighted_logit_x.bed",sep="\t")

conditions = [
    (df_met['methyl14_weighted_logit'] > 0.8),
    ...
    (df_met['methyl14_weighted_logit'] > 0.45) & (df_met['methyl14_weighted_logit'] <= 0.5),
    (df_met['methyl14_weighted_logit'] > 0.2) & (df_met['methyl14_weighted_logit'] <= 0.45),
...
df_met[["chrom","start","end","methy_level"]].to_csv(
    'context_prepared_methyl12_weighted_logit_x.methyl_level.bed', 
    index=False,
    header=False,
